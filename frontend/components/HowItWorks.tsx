        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#13141C] border border-gray-200 dark:border-white/5 rounded-2xl overflow-hidden flex flex-col hover:border-secondary/30 dark:hover:border-secondary/30 transition-all duration-300 group"
            >
              ...
              <div className="w-full aspect-[4/3] relative overflow-hidden bg-gray-200 dark:bg-[#0A0B0F]">
                ...
                />
                {/* Updated gradient overlay for light mode */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {bottomFeatures.map((feature, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#13141C] border border-gray-200 dark:border-white/5 rounded-2xl p-6 flex items-start gap-5 hover:bg-gray-100 dark:hover:bg-[#1A1B26] hover:border-gray-300 dark:hover:border-white/10 transition-all duration-300 shadow-sm dark:shadow-none"
            >
