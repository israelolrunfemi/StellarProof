  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-r from-[#256AF4] via-[##60A5FA] to-[#FF7CE9_30%]" /> */}
       <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_30%,_#1e2a3a_20%,_#0a0f1a_50%)]" />
      {/* Glow effects (optional, enhances the gradient) */}
      <div className="absolute left-0 top-0 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute right-0 bottom-0 translate-x-1/3 translate-y-1/3 w-[500px] h-[500px] bg-purple-500/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center px-6 pt-24 pb-20 md:pt-32 md:pb-28 mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-5 py-2 mb-10 flex items-center gap-2"
          >
          ...
          <motion.h1 variants={itemVariants} className="text-center max-w-4xl">
            <span className="block text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
              The Truth Engine
            </span>
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 text-center max-w-xl text-white/70 text-base md:text-lg leading-relaxed"
          >
          ...
          >
            ...
            <button className="px-8 py-3.5 rounded-lg border border-white/20 text-white font-semibold text-sm hover:bg-white/10 transition-all duration-200">
              View Documentation
            </button>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="mt-14 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-6 py-3 flex items-center gap-3"
          >
            ...
            <div>
              ...
              <p className="text-xs text-white/60">Hardware-Level Security</p>
            </div>
          </motion.div>
          ...
          >
            {features.map((feature) => (
              <motion.div
                key={feature.title}
                variants={itemVariants}
                className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:border-blue-400/30 hover:-translate-y-1"
              >
